...
$db['master']['username'] = "tlcthai";
$db['master']['password'] = "tlcth@!";
$db['master']['database'] = "tlcthai";
$db['master']['dbdriver'] = "Pdo_mysql";
$db['master']['dbprefix'] = "";
...
$db['slave']['username'] = "tlcthai";
$db['slave']['password'] = "tlcth@!";
$db['slave']['database'] = "tlcthai";
$db['slave']['dbdriver'] = "Pdo_mysql";
$db['slave']['dbprefix'] = "";
