...
<div class="container_16 clearfix" id="content">
	...
	<form method="post" action="/board/ajax_action/save/" id="form_post" id="form_post">
		...
		<div class="grid_5 clearfix" >
			...
			<input type="submit" name="btt_draft"  id="btt_preview"  value="บันทึกร่าง" style="padding:4px;">
			<input type="submit" name="btt_post"  id="btt_post"  value="เผยแพร่" style="padding:4px;"> 
			<input type="submit" name="btt_preview"  id="btt_preview"  value="ดูก่อน" style="padding:4px;">
			</div>
		</div>
